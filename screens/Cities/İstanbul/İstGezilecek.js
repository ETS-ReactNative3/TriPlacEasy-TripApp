...
export default class istGezilecek extends Component {
  ...
  size={55}/>
    ...
    <TouchableOpacity
          ...
          <Text style={({marginTop:'5%',color:color2,fontFamily:fontfam, fontSize: 45})}>
          İSTANBUL
          </Text>
          </View>
          ...
          <Text style={(styles.textBody, {color: color2,fontWeight:'700', fontSize: 35})}>
          ...
          <View style={{alignItems: 'center'}}>
                  <TouchableOpacity
                    onPress={()=>this.props.navigation.navigate('mapIst',{color:color,color2:color2,fontfam})}
                    style={styles.button}>
                    <Text style={{color: color2,fontWeight:'700', fontSize: 30}}>Haritadan </Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                    onPress={()=>this.props.navigation.navigate('listeIst',{color:color,color2:color2,fontfam})}
                    style={styles.button}>
